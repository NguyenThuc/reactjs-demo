...
const UserList = React.lazy(() => import('./views/components/users/UserList'))
const CategoryList = React.lazy(() => import('./views/components/category/list'))
const routes = [
  { path: '/', exact: true, name: 'Home' },
  { path: '/dashboard', name: 'Dashboard', component: Dashboard },
  { path: '/theme/typography', name: 'Typography', component: Typography },
  { path: '/base', name: 'Base', component: Cards, exact: true },
  { path: '/base/accordion', name: 'Accordion', component: Accordion, exact: true },
  ...
  { path: '/users', name: 'User', exact: true, component: UserList },
  { path: '/users/list', name: 'List', component: UserList },
  { path: '/category', name: 'Category', exact: true, component: CategoryList },
